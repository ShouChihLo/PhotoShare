...
import com.example.photoshare.databinding.FragmentShareBinding
...
class ShareFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val options = FirebaseRecyclerOptions.Builder<PostedMessage>()
            .setQuery(viewModel.messagesRef, PostedMessage::class.java)
            .build()
...
//        )
        ...
        binding.sendButton.setOnClickListener {
            ...
            hideKeyboard()
            if (checkMessage()) {
                viewModel.uploadMessage(requireActivity())
